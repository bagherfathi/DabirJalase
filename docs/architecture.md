...
- **Scaffold status:** `desktop-app/` and `python-services/` now include placeholder classes/modules, READMEs, and minimal build/test hooks so the team can begin implementing the MVP slice and wiring the CI templates described above.
