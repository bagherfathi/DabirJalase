...
- `GET /metrics` — lightweight counter snapshot to observe request volumes
- `GET /support/bundle` — download a deterministic diagnostics ZIP (settings, metrics, active sessions, and stored exports)
